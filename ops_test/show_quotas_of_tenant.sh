...
echo http get localhost:8774/v2/$tenant_id/os-quota-sets/$tenant_id x-auth-token:$token
http get localhost:8774/v2/$tenant_id/os-quota-sets/$tenant_id x-auth-token:$token
