...
echo ssh -p${port} -i ${key} root@${ip} "hostname; cd /root/cpu2006; ./stop_pressure.sh"
ssh -p${port} -i ${key} root@${ip} "hostname; cd /root/cpu2006; ./stop_pressure.sh; ps -ef|grep runspec"
